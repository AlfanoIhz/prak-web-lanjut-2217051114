...
<div class="bg-cover bg-center backdrop-blur-md" style="background-image: url('{{ asset('assets/img/bg-city.jpg') }}');">
    <div class="flex items-center justify-center h-screen">
        <div class="bg-cover bg-center text-black rounded-xl overflow-hidden w-4/5 md:w-4/5" style="background-image: url('{{ asset('assets/img/bg-city.jpg') }}');" >
            ...
            <form form id="createUser" action="{{ route('user.update', $user['id']) }}" method="POST" enctype="multipart/form-data" class="max-w-sm my-2 mx-auto">
                @csrf
                @method('PUT')
                <div class="mb-5">
                    <label for="nama" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                    <input type="text" id="nama" name="nama" value="{{ old('npm', $user->nama)}}" class="bg-gray-50 border border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-light focus:gray-light block w-full p-2.5 dark:bg-light-200 dark:border-gray-100 dark:placeholder-light-400 dark:text-black dark:focus:ring-gray-500">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="npm" name="npm" value="{{ old('npm', $user->npm)}}" class="bg-gray-50 border border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-light focus:gray-light block w-full p-2.5 dark:bg-light-200 dark:border-gray-100 dark:placeholder-light-400 dark:text-black dark:focus:ring-gray-500">
